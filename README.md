...
```sh
bun add --dev @hraness/direct@0.7.13
# or
npm install --save-dev @hraness/direct@0.7.13
```
...
```sh
git clone --branch v0.7.13 --depth 1 https://github.com/hraness/direct.git
cd direct
...
```sh
npx skills add hraness/direct#v0.7.13
# or
bunx skills add hraness/direct#v0.7.13
```
...
the npm registry at the exact 0.7.13 version. Follow the repository README, add
...
Prefer `npx skills add hraness/direct#v0.7.13` or
`bunx skills add hraness/direct#v0.7.13` for runner discovery. You can also copy
