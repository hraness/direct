...
```sh
bun add --dev @hraness/direct@0.7.10
# or
npm install --save-dev @hraness/direct@0.7.10
```
...
```sh
git clone --branch v0.7.10 --depth 1 https://github.com/hraness/direct.git
cd direct
...
```sh
npx skills add hraness/direct#v0.7.10
# or
bunx skills add hraness/direct#v0.7.10
```
...
the npm registry at the exact 0.7.10 version. Follow the repository README, add
...
Prefer `npx skills add hraness/direct#v0.7.10` or
`bunx skills add hraness/direct#v0.7.10` for runner discovery. You can also copy
