...
```sh
git clone --branch v0.7.12 --depth 1 https://github.com/hraness/direct.git
cd direct
...
the npm registry at the exact 0.7.12 version. Follow the repository README, add
...
Prefer `npx skills add hraness/direct#v0.7.12` or
`bunx skills add hraness/direct#v0.7.12` for runner discovery. You can also copy
